 ...
 Polynomial operator*( Polynomial  & p2)
{
     ...
     // the above thing is to multiply the values & after multiply we have to add numbers of same degree.    
        
         p3=p3 + p; //function call
         
     }
     
     // if p1 & p2 has 3 terms at 0, 1, 2 idx so,
     // basically we have 3 p's which are adding with p3 upto 3 times.
    return p3; 
